 ...
 */
class Entreprise extends \SS\PlatformBundle\Entity\Entreprise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'id', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'nom', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'adresse', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'email', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'tel', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'logo', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'domaine', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'description', '' . "\0" . 'SS\\PlatformBundle\\Entity\\Entreprise' . "\0" . 'offres'];
        }
     ...
     * {@inheritDoc}
     */
    public function addOffres(\SS\PlatformBundle\Entity\Offre $offre)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addOffres', [$offre]);

        return parent::addOffres($offre);
    }
